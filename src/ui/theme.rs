...
pub const MIDNIGHT: Palette = Palette {
    ...
    border: Color32::from_rgb(43, 47, 56),
    card: Color32::from_rgb(30, 33, 40),
    card_hover: Color32::from_rgb(38, 42, 52),
    text: Color32::from_rgb(232, 234, 237),
    muted: Color32::from_rgb(139, 146, 158),
    faint: Color32::from_rgb(99, 105, 117),
    ok: Color32::from_rgb(52, 211, 153),
    warn: Color32::from_rgb(251, 191, 36),
    bad: Color32::from_rgb(248, 113, 113),
