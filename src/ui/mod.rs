...
use theme::Palette;
use widgets::{badge, bar, dot, monogram_ring, pct_color};
...
/// `hovered` paints the chip's hover background.
...
pub fn provider_card(ui: &mut egui::Ui, s: &Snapshot, pct: Option<f64>, pal: &Palette, alpha: f32, stale: bool) {
    ...
    egui::Frame::none()
        ...
        .show(ui, |ui| {
            ...
            // header: monogram + name + fidelity badge · age
            ui.horizontal(|ui| {
