...
export default function Home() {
  return <main>
    ...
    <section className="final-cta container"><span className="section-kicker">OPEN SOURCE</span><h2>Keep your context.<br /><em>Lose the quota anxiety.</em></h2><p>Download the native Linux monitor, or build it from source. Contributions are welcome.</p><a className="button" href={RELEASES}>Download for Linux <span>↓</span></a><small>MIT licensed · Built with Rust + egui</small></section>
