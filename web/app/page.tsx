...
export default function Home() {
  return <main>
    ...
    <section className="final-cta container"><span className="section-kicker">PRIVATE TESTING PREVIEW</span><h2>Keep your context.<br /><em>Lose the quota anxiety.</em></h2><p>Request access to the native Linux monitor and help shape the product before the public release.</p><a className="button" href={RELEASES}>Request the preview <span>↓</span></a><small>Private testing build · public release coming later</small></section>
